...
%   
% 	Description: MLP/Linear Regression Preprocessing - Stage 2
...
% Plot PD signal's features
 ...
 legend('Raw EMG','RMS','Location','northoutside','Orientation','horizontal');
    ...
    xlabel('time (s)');
    ylabel('EMG Voltage');
    title('Processing Posterior Deltoid EMG tricep data');
    index = index + 1;
%% Store into excel 
...
%  xlswrite(filename2,titles,1,'A1:C1');
%  xlswrite(filename2,store,1,'A2:C4201');
%  xlswrite(filename2,titles_t,1,'G1:I1');
%  xlswrite(filename2,store_t,1,'G2:I4201');
