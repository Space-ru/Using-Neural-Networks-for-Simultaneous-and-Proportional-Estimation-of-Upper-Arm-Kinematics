...
if trialnumber == 1
    filename = 'Dynamic Trial - Horizontal Shld - 01.csv';           % File from which EMG and joint angle are read.
    filename2 = 'TestTrial1.mat';      % File to which corresponding features and angle are written.
elseif trialnumber == 2
    filename = 'Dynamic Trial - Horizontal Shld - 02.csv';
    filename2 = 'TestTrial2.mat';
elseif trialnumber == 3
    filename = 'Dynamic Trial - Horizontal Shld - 03.csv';
    filename2 = 'TestTrial3.mat';
elseif trialnumber == 4
    filename = 'Dynamic Trial - Horizontal Shld - 04.csv';
    filename2 = 'TestTrial4.mat';
elseif trialnumber == 5
    filename = 'Dynamic Trial - Horizontal Shld - 05.csv';
    filename2 = 'TestTrial5.mat';
elseif trialnumber == 6
    filename = 'Dynamic Trial - Horizontal Shld - 06.csv';
    filename2 = 'TestTrial6.mat';
elseif trialnumber == 7
    filename = 'Dynamic Trial - Horizontal Shld - 07.csv';
    filename2 = 'TestTrial7.mat';
elseif trialnumber == 8
    filename = 'Dynamic Trial - Horizontal Shld - 08.csv';
    filename2 = 'TestTrial8.mat';
elseif trialnumber == 9
    filename = 'Dynamic Trial - Horizontal Shld - 09.csv';
    filename2 = 'TestTrial9.mat';
elseif trialnumber == 10
    filename = 'Dynamic Trial - Horizontal Shld - 10.csv';
...
X1range = 'L42012:L46211';
Y1range = 'M42012:M46211';
Z1range = 'N42012:N46211';
...
ViconX1 = xlsread(filename,X1range);  % Chest marker
