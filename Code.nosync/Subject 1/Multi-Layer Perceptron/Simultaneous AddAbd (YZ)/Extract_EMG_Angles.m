...
if trialnumber == 1
    filename = 'Dynamic Trial - Composite Adduction - 01.csv';           % File from which EMG and joint angle are read.
    filename2 = 'TestTrial1.mat';      % File to which corresponding features and angle are written.
elseif trialnumber == 2
    filename = 'Dynamic Trial - Composite Adduction - 02.csv';
    filename2 = 'TestTrial2.mat';
elseif trialnumber == 3
    filename = 'Dynamic Trial - Composite Adduction - 03.csv';
    filename2 = 'TestTrial3.mat';
elseif trialnumber == 4
    filename = 'Dynamic Trial - Composite Adduction - 04.csv';
    filename2 = 'TestTrial4.mat';
elseif trialnumber == 5
    filename = 'Dynamic Trial - Composite Adduction - 05.csv';
    filename2 = 'TestTrial5.mat';
elseif trialnumber == 6
    filename = 'Dynamic Trial - Composite Adduction - 06.csv';
    filename2 = 'TestTrial6.mat';
elseif trialnumber == 7
    filename = 'Dynamic Trial - Composite Adduction - 07.csv';
    filename2 = 'TestTrial7.mat';
elseif trialnumber == 8
    filename = 'Dynamic Trial - Composite Adduction - 08.csv';
    filename2 = 'TestTrial8.mat';
elseif trialnumber == 9
    filename = 'Dynamic Trial - Composite Adduction - 09.csv';
    filename2 = 'TestTrial9.mat';
elseif trialnumber == 10
    filename = 'Dynamic Trial - Composite Adduction - 10.csv';
