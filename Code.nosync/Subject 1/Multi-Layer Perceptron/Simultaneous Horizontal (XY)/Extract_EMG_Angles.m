...
if trialnumber == 1
    filename = 'Dynamic Trial - Composite Extension - 01.csv';           % File from which EMG and joint angle are read.
    filename2 = 'TestTrial11.mat';      % File to which corresponding features and angle are written.
elseif trialnumber == 2
    filename = 'Dynamic Trial - Composite Extension - 02.csv';
    filename2 = 'TestTrial12.mat';
elseif trialnumber == 3
    filename = 'Dynamic Trial - Composite Extension - 03.csv';
    filename2 = 'TestTrial13.mat';
elseif trialnumber == 4
    filename = 'Dynamic Trial - Composite Extension - 04.csv';
    filename2 = 'TestTrial14.mat';
elseif trialnumber == 5
    filename = 'Dynamic Trial - Composite Extension - 05.csv';
    filename2 = 'TestTrial15.mat';
elseif trialnumber == 6
    filename = 'Dynamic Trial - Composite Extension - 06.csv';
    filename2 = 'TestTrial16.mat';
elseif trialnumber == 7
    filename = 'Dynamic Trial - Composite Extension - 07.csv';
    filename2 = 'TestTrial17.mat';
elseif trialnumber == 8
    filename = 'Dynamic Trial - Composite Extension - 08.csv';
    filename2 = 'TestTrial18.mat';
elseif trialnumber == 9
    filename = 'Dynamic Trial - Composite Extension - 09.csv';
    filename2 = 'TestTrial19.mat';
elseif trialnumber == 10
    filename = 'Dynamic Trial - Composite Extension - 10.csv';
   filename2 = 'TestTrial20.mat';
end
