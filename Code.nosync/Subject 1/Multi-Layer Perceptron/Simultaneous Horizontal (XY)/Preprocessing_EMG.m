...
columnE = data(:,6); % Posterior Deltoid EMG
columnF = data(:,7); % Pectoralis EMG  NOTE: although this signal was processed, it was not used in the end.
...
%% Set bicep, tricep, AD and PD limits
maxb = 0.0058;
minb = 0.0025;
maxt = 0.0068;
mint = 0.000305;
...
y2 = columnD(1:duration); % define joint angles
%% Plots
%Plot joint signal
 figure;
 subplot(2,1,1);
 ...
 % Plot PD signal's features
    ...
    xlabel('time (s)');
    ylabel('EMG Voltage');
    title('Processing EMG Pectoralis Major data');   
