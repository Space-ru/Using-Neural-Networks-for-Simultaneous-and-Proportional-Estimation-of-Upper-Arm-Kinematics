...
L1 = 284; % length of elbow, shoulder joint (calculated from average of one trial)
L2 = 245; % length of elbow, wrist joint

%% Forward kinematics
X_WRT= L1.*sind(y(2,:))+ L2.*sind(y(1,:)-y(2,:));
Y_WRT=-L1.*cosd(y(2,:))+ L2.*cosd(y(1,:)-y(2,:));
