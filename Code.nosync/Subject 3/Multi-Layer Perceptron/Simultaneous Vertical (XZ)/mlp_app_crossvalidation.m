...
for trialnumber = 1:4
 if trialnumber == 1
    ...
    filename5 = 'FeaturesTrialsim7.mat';
    filename6 = 'FeaturesTrialsim2.mat';
elseif trialnumber == 2
    filename1 = 'FeaturesTrialsim3.mat';
    filename2 = 'FeaturesTrialsim1.mat';
    filename3 = 'FeaturesTrialsim2.mat';
...
elseif trialnumber == 3
    ...
    filename3 = 'FeaturesTrialsim7.mat';
    filename4 = 'FeaturesTrialsim8.mat';
    filename5 = 'FeaturesTrialsim9.mat';
    filename6 = 'FeaturesTrialsim5.mat';
elseif trialnumber == 4
    ...
    filename4 = 'FeaturesTrialsim8.mat';
    filename5 = 'FeaturesTrialsim9.mat';
    filename6 = 'FeaturesTrialsim3.mat';
end
...
input = [RMS RMS2 RMS3 RMS4 RMS5 RMS6; RMS_t RMS_t2 RMS_t3 RMS_t4 RMS_t5 RMS_t6; RMS_p RMS_p2 RMS_p3 RMS_p4 RMS_p5 RMS_p6];
x = input;
...
net.trainParam.epochs = 20;  %150              %setting the amount of training epochs
