...
for trialnumber = 1:5 % adjust accordingly
...
title('Processing EMG data using three features');
...
%  
%  xlswrite(filename2,titles,1,'A1:E1');
%  xlswrite(filename2,store,1,'A2:E4201');
%  xlswrite(filename2,titles_t,1,'G1:K1');
%  xlswrite(filename2,store_t,1,'G2:K4201');
